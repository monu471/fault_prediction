...
from fault_prediction.sensor.utils import load_object
...
class ModelEvaulation:
    ...
    def __init__(self,model_eval_config,data_ingestion_artifact,data_transformation_artifact,model_trainer_artifact): 
        try:
